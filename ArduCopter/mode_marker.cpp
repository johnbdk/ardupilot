...
bool ModeMarker::init(bool ignore_checks)
{
...
void ModeMarker::run()
{
    gcs().send_text(MAV_SEVERITY_CRITICAL, "Hello from MARKER mode!");
    // if (land_with_gps) {
    //     gps_run();
    // } else {
    //     nogps_run();
...
void ModeMarker::do_not_use_GPS()
{
    // land_with_gps = false;
}
